package de.alectogmbh.friendsurance.automation.steps.web.insurance.purchase.liability;

import de.alectogmbh.friendsurance.automation.pages.web.insurance.checkout.liability.LiabilityCheckoutMMPage;
...
public class LiabilityCheckoutMMSteps extends AbstractScenarioSteps<LiabilityCheckoutMMPage> {

  private LiabilityCheckoutMMPage liabilityCheckoutMMPage;
  ...
  @Step
  public void enter_employer_address(String employerAddress) {
    getPageObject().enterEmployerAddress(employerAddress);
  }
  ...
  public void check_success_page() {
    getPageObject().waitForPresenceOf("//*[text() = 'Bonus sichern']");
  ...
  public void enter_first_page(CustomerData data) {
    ...
    enter_employer_address(data.getStreet());
  ...
  @Override
  public LiabilityCheckoutMMPage getPageObject() {
    return liabilityCheckoutMMPage;
  }
}
