package de.alectogmbh.friendsurance.automation.steps.web.insurance.purchase.legal;

import de.alectogmbh.friendsurance.automation.pages.web.insurance.checkout.legal.LegalCheckoutMMPage;
...
public class LegalCheckoutMMSteps extends AbstractScenarioSteps<LegalCheckoutMMPage> {

  private LegalCheckoutMMPage legalCheckoutMMPage;
  ...
  public void check_success_page() {
    getPageObject().waitForPresenceOf("//*[text() = 'Versicherung abschließen']");
  ...
  @Override
  public LegalCheckoutMMPage getPageObject() {
    return legalCheckoutMMPage;
  }
}
